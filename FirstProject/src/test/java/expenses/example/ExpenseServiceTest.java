...
public class ExpenseServiceTest {
    ...
    void testCreateExpense() {
        ...
        assertTrue(expenseService.createExpense(1, new Date(), 50.00, "Dummy"));
        assertFalse(expenseService.createExpense(test.getId(), test.getDate(),
                test.getValue(), test.getMerchant()));
    }
